  ...
  return (
    <>
      <div className="p-4 pb-3">
        <Link href="/clientdashboard" onClick={onNavigate} className="flex items-center gap-3 px-1 py-1">
          ...
          <div>
            ...
            <p className="mono mt-0.5 text-[9px] tracking-[0.14em] text-[#a7a79e]">MEMBER</p>
          </div>
        </Link>
        <Link
